...
public class Test1  {
	...
	public void crmTest1() throws Exception {
		 ...
		 * "svcQSETA@republicfinance.com.qa");
		 * driver.findElement(By.id("password")).click();
		 * driver.findElement(By.id("password")).clear();
		 * driver.findElement(By.id("password")).sendKeys("-tEp66BWR#F#P*");
		 * Thread.sleep(8000); driver.findElement(By.id("Login")).click();
		 * //Thread.sleep(8000);
		 */
		...
		driver.findElement(By.xpath("//*[@id='okta-signin-username']")).sendKeys("pvenkatarajan@republicfinance.com");
		driver.findElement(By.xpath("//*[@id='okta-signin-password']")).click();
		driver.findElement(By.xpath("//*[@id='okta-signin-password']")).clear();
		driver.findElement(By.xpath("//*[@id='okta-signin-password']")).sendKeys("P@ssword123mm123#");
		Thread.sleep(500);
		...
		// | ]]
		driver.get("https://republic.okta.com/app/salesforce/exk1y2a6uext0cYkP0h8/sso/saml");
		driver.get(
		...
		driver.get("https://republicfinance--qa.sandbox.lightning.force.com/one/one.app");
		driver.get(
	...
	public void crmTest2() throws Exception {
			...
			try {
			// Thread.sleep(3000);
			((JavascriptExecutor) driver).executeScript("arguments[0].click();", driver.findElement(By.xpath("//*[@title= 'Branch Operations']")));
			Thread.sleep(3000);
			}	catch (Exception e) {
	        ...
	        try {
	           ...
	           try {
	                element = driver.findElement(By.xpath("//div[contains(@class, 'slds-global-header__item_search')]//input"));
	      ...
	      /*
	         try {
	            ...
	            element = driver.findElement(By.xpath("//div[contains(@class, 'slds-global-header__item_search')]"));
	            System.out.println("Element found using the third XPath");
	        } catch (NoSuchElementException e) {
	            System.out.println("The 3rd xpath failed"); }
  */
	       ...
	       // JavascriptExecutor js1 = (JavascriptExecutor) driver;
	        ...
	        element.click();
	        Thread.sleep(8000);
	        element.sendKeys("MARTHA YYCPXHA");
	        Thread.sleep(8000);
	        element.sendKeys(Keys.ENTER);
			*/
			...
			*/
			/*
			a1.sendKeys(Keys.SHIFT, Keys.TAB).perform();
			 a1.sendKeys(Keys.SHIFT, Keys.TAB).perform();
			 a1.sendKeys(Keys.SHIFT, Keys.TAB).perform();
			 a1.sendKeys(Keys.SHIFT, Keys.TAB).perform();
			 a1.sendKeys(Keys.SHIFT, Keys.TAB).perform();
			...
			*/
			...
			//driver.findElement(By.xpath("//input[1]")); }
		       List<WebElement> elements = driver.findElements(By.xpath("//input[1]"));
   	        if (!elements.isEmpty()) {
			...
			driver.findElement(By.xpath("(//input[@type='search'])[2]")).sendKeys("MARTHA YYCPXHA");
			Thread.sleep(5000);
			*/
			...
			*/
			/*
			for (int i = 1; i < 3; i++) {
			driver.findElement(By.xpath("//input[contains(@class, 'slds-input') and contains(@id, 'input-') and @autocomplete='off']"));
			System.out.println("search customer loop");
			}
			driver.findElement(By.xpath("//input[contains(@class, 'slds-input') and contains(@id, 'input-') and @autocomplete='off']")).click();
			driver.findElement(By.xpath("//input[contains(@class, 'slds-input') and contains(@id, 'input-') and @autocomplete='off']")).sendKeys("MARTHA YYCPXHA");
			*/
			...
			*/
			...
			wait0.until(ExpectedConditions.elementToBeClickable(
					driver.findElement(By.xpath("(//span[@title='Start'][normalize-space()='Start'])[3]"))));
...
*/
			...
			List<String> xPaths1 = Arrays.asList(
		        ...
		        if (!found) {
		            System.out.println("start button find - ArrayList - No element3 found with any of the provided list of XPaths.");
		        }
		...
		for(int i=1; i<7; i++) { a1.sendKeys(Keys.TAB).perform(); }
		a1.sendKeys(Keys.ENTER).perform();
		Thread.sleep(8000);
	...
	public void crmTest3() throws Exception 
	{
		...
		*/
		...
		Thread.sleep(20000);
		driver.findElement(By.xpath("//h3[text()='Please verify the information below is correct, update any incorrect/outdated information & fill in any additional fields.']")).click();
	
		a1.sendKeys(Keys.TAB).perform();
		Thread.sleep(1000);
		a1.sendKeys(Keys.TAB).sendKeys(Keys.ARROW_LEFT).perform();
		Thread.sleep(500);
		for(int i=1; i<6; i++) { a1.sendKeys(Keys.TAB).perform(); }
		a1.sendKeys(Keys.TAB).sendKeys(Keys.ARROW_LEFT).perform();
		Thread.sleep(500);
		a1.sendKeys(Keys.TAB).perform();
		Thread.sleep(500);
		...
		Thread.sleep(500);
		for(int i=1; i<4; i++) { a1.sendKeys(Keys.TAB).perform(); }
		...
		a1.sendKeys(Keys.ENTER).perform();
		Thread.sleep(500);
		for(int i=1; i<4; i++) { a1.sendKeys(Keys.ARROW_DOWN).perform();}
		Thread.sleep(500);
		a1.sendKeys(Keys.ENTER).perform();
		Thread.sleep(10000);
		
		try {
		driver.findElement(By.xpath("(//*[contains(text(), 'By submitting the information in this application for credit')]/preceding-sibling::span[@class='slds-checkbox_faux'])[1]")).click();
		Thread.sleep(20000);
		...
		List<String> xPaths2 = Arrays.asList(
	        ...
	        boolean found2 = false;
	         ...
	         for (String xpath02 : xPaths2) {
	            try {
	                WebElement element4 = driver.findElement(By.xpath(xpath02));
	                ...
	                System.out.println("Element3 not found using XPath: " + xpath02);
	            }
	        }
	        if (!found2) {
	            System.out.println("ArrayList - No element3 found with any of the provided list of XPaths.");
	        }
	
	        
	        Thread.sleep(5000);
	        driver.findElement(By.xpath("//input[contains(@id, 'input66-')]")).click();
	        driver.findElement(By.xpath("//input[contains(@id, 'input66-')]")).sendKeys("100");
	        Thread.sleep(1000);
	...
	public void crmTest4() throws Exception 
	{
		...
		*/
		...
		Thread.sleep(25000);
			...
			WebElement e7 = driver.findElement(By.xpath("//p[text()='Note that alimony, child support, or separate maintenance income need not be revealed if you do not wish to have it considered as a basis of repaying this obligation.']"));
		...
		for(int i=1; i<5; i++) { a1.sendKeys(Keys.TAB).perform(); }
		a1.sendKeys(Keys.ENTER).perform();
		Thread.sleep(500);
		...
		e7.click();
		for(int i=1; i<9; i++) { a1.sendKeys(Keys.TAB).perform(); }
		Thread.sleep(5000);
		waitForPageToLoad(driver);
		System.out.println("Waiting for page to fully load.");
		js.executeScript("window.scroll(0,0);");
	...
	public void crmTest5() throws Exception 
	{
		...
		*/
		...
		System.out.println("test5 load completed");
    		...
    		//Thread.sleep(9000);
        	//WebElement e8 = driver.findElement(By.xpath("//h3[text()='Verifications']"));
        	//p[text()='Tell me about any unsatisfied judgments you may have, if applicable.']"));
		...
		*/
		...
		//e8.click();
		//driver.findElement(By.xpath("//p[text()='Tell me about any unsatisfied judgments you may have, if applicable.']")).click();
		...
		for(int i=1; i<18; i++) { a1.sendKeys(Keys.TAB).perform(); }
		//Thread.sleep(500);
		//a1.sendKeys(Keys.ENTER).perform();
		Thread.sleep(9000);
		...
		*/
        ...
        try {
            ...
            */
			...
			driver.findElement(By.xpath("//*[text()='Personal Information Verification']")).click();
			Thread.sleep(2000);
			for(int i1=1; i1<14; i1++) { a1.sendKeys(Keys.TAB).perform(); }
			Thread.sleep(2000);
			a1.sendKeys(Keys.ENTER).perform();
			Thread.sleep(500);
			a1.sendKeys(Keys.ARROW_DOWN).perform();
			...
			for(int i2=1; i2<3; i2++) { a1.sendKeys(Keys.TAB).perform(); }
			a1.sendKeys(Keys.ENTER).perform();
			Thread.sleep(500);
			a1.sendKeys(Keys.ARROW_DOWN).perform();
			a1.sendKeys(Keys.ARROW_DOWN).perform();
        ...
        try {
			...
			for(int i1=1; i1<4; i1++) { a1.sendKeys(Keys.TAB).perform(); }
			a1.sendKeys(Keys.ARROW_DOWN).perform(); 
			a1.sendKeys(Keys.ENTER).perform();
			Thread.sleep(500);
			a1.sendKeys(Keys.TAB).perform(); 
			...
			for(int i1=1; i1<3; i1++) { a1.sendKeys(Keys.TAB).perform(); }
			Thread.sleep(500);
			a1.sendKeys(Keys.ENTER).perform();
			Thread.sleep(500);
			a1.sendKeys(Keys.ARROW_DOWN).perform(); 
	...
	public void crmTest7() throws Exception 
	{
		...
		*/
        ...
        //	WebDriverWait wait8 = new WebDriverWait(driver, Duration.ofSeconds(60));
			...
			for(int i=1; i<11; i++) { a1.sendKeys(Keys.TAB).perform(); }
			e8.click();
			for(int i=1; i<25; i++) { a1.sendKeys(Keys.TAB).perform(); }
			a1.sendKeys("Need Approval").perform();
			waitForPageToLoad(driver);
        	js.executeScript("window.scroll(0,0);");
        	driver.findElement(By.xpath("//*[text()='Needs Review']")).click();
        	...
        	*/
			...
			pointer click
			24th tab 
			sendkets - need approval
			wait fr pg load - 30
			click xpath = //*[text()='Needs Review']
			wait fr pg load - 10
			click xpath = //*[text()='Send for Review']
			tab plus space
			3rd tab n enter
			*/
