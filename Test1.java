...
public class Test1 {
	...
	public void crmTest2() throws Exception {
		...
		try {
			WebElement element3 = driver.findElement(By.xpath("(//omnistudio-flex-action[contains(@class, 'flexActionElement')]//a[contains(@class, 'slds-action_item')])[66]"));
	...
	public void crmTest8() throws InterruptedException {
		 ...
		 */
			  ...
			  actions.sendKeys(Keys.ENTER).perform(); 
			  Thread.sleep(30000);
			  System.out.println(" reference added" +i2);
			  Thread.sleep(2000);
			  }
